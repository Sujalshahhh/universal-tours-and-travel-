...
background: -webkit-linear-gradient(to right, #6A67CE, #fff);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to right, #6A67CE, #fff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By sujal shah & this team<br><br></div>
	<!-- <p>----------</p> -->
