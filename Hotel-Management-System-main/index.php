...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
                <img class="carousel-image" src="./image/luxury/luxury-1.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/luxury/luxury-2.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/luxury/luxury-3.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/luxury/luxury-6.jpg">
            </div>
        </div>
    </section>
